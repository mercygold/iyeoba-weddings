...
function CategoryIcon({ category }: { category: string }) {
  ...
  switch (category) {
    ...
    case "Traditional Wedding Services":
      return (
        <svg {...commonProps}>
          <path d="M7.5 12.5l-2-2a2.8 2.8 0 014-4l2.5 2.5 2.5-2.5a2.8 2.8 0 014 4l-6.5 6.5-2.2-2.2" />
          <path d="M3 15l4 4" />
          <path d="M21 15l-4 4" />
        </svg>
      );
    case "Venues & Hospitality":
      return (
        <svg {...commonProps}>
    ...
    case "Jewelry & Accessories":
      return (
        <svg {...commonProps}>
          <path d="M6 9l3-4h6l3 4-6 10L6 9z" />
          <path d="M6 9h12" />
          <path d="M9 5l3 4 3-4" />
        </svg>
      );
    case "Printing & Invitations":
      return (
        <svg {...commonProps}>
    ...
    case "Florals & Bouquets":
      return (
        <svg {...commonProps}>
          <path d="M12 13c-3-1.5-4.5-4-3-7 3 1 4.5 3.5 3 7z" />
          <path d="M12 13c3-1.5 4.5-4 3-7-3 1-4.5 3.5-3 7z" />
          <path d="M12 13v8" />
          <path d="M8 21h8" />
        </svg>
      );
